...
<script>
  function mostrarPreco1() {
    ...
    switch (tamanhoSelecionado1) {
      case "pp":
        preco1 = "1000 sacolas: R$ 3,14 por unidade<br>" +
                "500 sacolas: R$ 3,44 por unidade<br>" +
                "300 sacolas: R$ 3,74 por unidade<br>" +
                "200 sacolas: R$ 3,90 por unidade<br>" +
                "100 sacolas: R$ 4,88 por unidade";
        break;
      case "p":
        preco1 = "1000 sacolas: R$ 3,24 por unidade<br>" +
                "500 sacolas: R$ 3,59 por unidade<br>" +
                "300 sacolas: R$ 3,89 por unidade<br>" +
                "200 sacolas: R$ 3,93 por unidade<br>" +
                "100 sacolas: R$ 4,91 por unidade";
        break;
      case "m":
        preco1 = "1000 sacolas: R$ 3,53 por unidade<br>" +
                "500 sacolas: R$ 3,79 por unidade<br>" +
                "300 sacolas: R$ 3,89 por unidade<br>" +
                "200 sacolas: R$ 4,14 por unidade<br>" +
                "100 sacolas: R$ 5,12 por unidade";
        break;
      case "g":
        preco1 = "1000 sacolas: R$ 3,91 por unidade<br>" +
                "500 sacolas: R$ 4,14 por unidade<br>" +
                "300 sacolas: R$ 4,32 por unidade<br>" +
                "200 sacolas: R$ 4,68 por unidade<br>" +
                "100 sacolas: R$ 5,66 por unidade";
        break;
      default:
        preco1 = "";
    }
...
<script>
  function mostrarPreco2() {
    ...
    switch (tamanhoSelecionado2) {
      case "pp":
        preco2 = "1000 sacolas: R$ 3,34 por unidade<br>" +
                "500 sacolas: R$ 3,74 por unidade<br>" +
                "300 sacolas: R$ 4,04 por unidade<br>" +
                "200 sacolas: R$ 4,20 por unidade<br>" +
                "100 sacolas: R$ 5,18 por unidade";
        break;
      case "p":
        preco2 = "1000 sacolas: R$ 3,50 por unidade<br>" +
                "500 sacolas: R$ 3,89 por unidade<br>" +
                "300 sacolas: R$ 4,09 por unidade<br>" +
                "200 sacolas: R$ 4,23 por unidade<br>" +
                "100 sacolas: R$ 5,21 por unidade";
        break;
      case "m":
        preco2 = "1000 sacolas: R$ 3,83 por unidade<br>" +
                "500 sacolas: R$ 4,09 por unidade<br>" +
                "300 sacolas: R$ 4,34 por unidade<br>" +
                "200 sacolas: R$ 4,44 por unidade<br>" +
                "100 sacolas: R$ 5,42 por unidade";
        break;
      case "g":
        preco2 = "1000 sacolas: R$ 4,02 por unidade<br>" +
                "500 sacolas: R$ 4,24 por unidade<br>" +
                "300 sacolas: R$ 4,42 por unidade<br>" +
                "200 sacolas: R$ 4,78 por unidade<br>" +
                "100 sacolas: R$ 5,76 por unidade";
        break;
      default:
        preco2 = "";
    }
